...
func _run() -> void:
	...
	var configs: Array[Dictionary] = [
		...
		{"name": "태양 여우 솔", "is_ai": true, "char_icon": "res://assets/characters/eco_roster/solar_fox_sol.png", "char_color": Color("ffd24a")},
		{"name": "물방울 정령 포포", "is_ai": true, "char_icon": "res://assets/characters/eco_roster/water_popo.png", "char_color": Color("49bfff")},
		{"name": "번개새 피카", "is_ai": true, "char_icon": "res://assets/characters/eco_roster/lightning_bird_pika.png", "char_color": Color("ff9d3d")}
	]
